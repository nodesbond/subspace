...
use sp_domains::{
    BundleSolution, DomainId, GenerateGenesisStateRoot, OperatorId, OperatorPair, RuntimeType,
};
...
pub(crate) fn create_dummy_receipt(
    ...
    parent_domain_block_receipt: H256,
    block_extrinsics_roots: Vec<H256>,
) -> ExecutionReceipt<BlockNumber, Hash, BlockNumber, H256, u64> {
    ExecutionReceipt {
        domain_block_height: block_height,
        parent_domain_block_receipt,
        consensus_block_height: block_height,
...
fn create_dummy_bundle(
    ...
    block_height: BlockNumber,
    consensus_block_hash: Hash,
) -> OpaqueBundle<BlockNumber, Hash, BlockNumber, H256, u64> {
...
pub(crate) fn create_dummy_bundle_with_receipts(
    ...
    receipt: ExecutionReceipt<BlockNumber, Hash, BlockNumber, H256, u64>,
) -> OpaqueBundle<BlockNumber, Hash, BlockNumber, H256, u64> {
    ...
    OpaqueBundle {
        ...
        extrinsics: Vec::new(),
        execution_trace: if block_height == 0 {
            Vec::new()
        } else {
...
impl GenerateGenesisStateRoot for GenesisStateRootGenerater {
    fn generate_genesis_state_root(&self, _runtime_type: RuntimeType) -> Option<H256> {
